...
| Task planning and progress | Approved observations produce ordered plan segments. Fix mode runs continuously without eight-action or two-minute checkpoints; every action is freshly grounded and observed locally. Page changes in the selected window automatically recapture and replan without repeated approval or old-target reuse. Genuine input/permission/new-window boundaries and uncertain outcomes still stop. Completion bubbles hide after five seconds; results remain in Details and goal completion is not independently verified. |
